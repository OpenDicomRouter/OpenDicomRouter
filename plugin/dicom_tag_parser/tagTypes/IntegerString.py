class IntegerString:
    ...
    def parse_integer_string(self,integer_string: str):
        ...
        """
        stripped_integer_string = integer_string.strip()
        if stripped_integer_string.startswith('+'):
            integer = int(stripped_integer_string[1:])
        elif stripped_integer_string.startswith('-'):
            integer = -1 * int(stripped_integer_string[1:])
        else: 
            integer =  int(stripped_integer_string)
